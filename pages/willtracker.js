...
export default function WillTracker() {
  useEffect(() => {
    ...
    container.innerHTML = `
      ...
      <div class="elfsight-app-6ce22393-5461-4785-8ba6-b95a76c56a1b" data-elfsight-app-lazy></div>
    `;
  ...
  return null; // Return null since the component is dynamically creating elements
}